...
/// Example usage:
///
/// final service = StoveDetectionService(baseUrl: 'http://192.168.1.100:8000');
/// 
...
/// 
/// // Detect from file
/// final result = await service.detectObjects('/path/to/image.jpg');
/// if (result != null && result.stoveDetected) {
///   print('Stove detected with ${result.detections.length} objects!');
/// }
/// 
/// // Or detect from camera bytes
/// final cameraResult = await service.detectFromBytes(imageBytes);
