...
class _StoveDetectorScreenState extends State<StoveDetectorScreen> {
  ...
  Future<void> _initializeVoiceService() async {
    ...
    // Set hands-free mode
    _voiceAssistant!.setHandsFreeMode(_handsFreeMode);
            ...
            children: [
              Row(
                children: [
                  ...
                  IconButton(
                    icon: Icon(
                      _handsFreeMode ? Icons.sync_disabled : Icons.sync,
                      color: _handsFreeMode ? Colors.green : Colors.grey,
                    ),
                    onPressed: () {
                      setState(() {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            _handsFreeMode 
                                ? '👋 Hands-free mode ON - Continuous listening' 
                                : '✋ Hands-free mode OFF - Manual button required',
                          ),
                          duration: const Duration(seconds: 2),
                        ),
                      );
                    },
                    tooltip: _handsFreeMode ? 'Disable Hands-free' : 'Enable Hands-free',
                  ),
